...
class HolisticCameraViewControllerHolder: ObservableObject {
    @Published var controller: HolisticCameraViewController?
    ...
    func createController(targetSign: String) {
        ...
        let newController = HolisticCameraViewController()
...
struct HolisticHostedViewController: UIViewControllerRepresentable {
    var controllerHolder: HolisticCameraViewControllerHolder
    var targetSign: String
    var isCorrectSign: Bool
    
    init(controllerHolder: HolisticCameraViewControllerHolder, targetSign: String, isCorrectSign: Bool) {
    ...
    func updateUIViewController(_ uiViewController: UIViewController, context: Context) {
        ...
        if let cameraVC = uiViewController as? HolisticCameraViewController,
